...
import com.ylean.expand.network.body.ResponseProgressBody;
import com.ylean.expand.network.callback.MyDownloadCallback;
...
public class DownloadBuilder {
    ...
    public Call enqueue(final DownloadResponseHandler downloadResponseHandler) {
        try {
            ...
            Log.e("Download enqueue error:" + e.getMessage());
